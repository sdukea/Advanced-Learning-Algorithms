...
# 21/6/26, 11:24 PM
# From here, we can set the parameters but will have to learn backpropogration for it
# as activation function has changed and activations change and so have to use new parameters
# for this and cannot copy from 'coffee_roasting_NumPy.py'
# So, keeping the understanding of ReLU intact and moving on to Softmax implementation to then 
# finish it and start backpropogation, its calculus and more.
